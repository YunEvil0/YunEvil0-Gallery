...
package com.traveler54.util.logging;

import java.io.File;

import org.apache.log4j.PropertyConfigurator;

import com.traveler54.util.logging.jdk.JdkESLoggerFactory;
import com.traveler54.util.logging.log4j.Log4jESLoggerFactory;
...
public abstract class ESLoggerFactory {
	...
	static {
		...
		try {
			...
			case "mac os x":
				location = "conf/log4j.properties";
				break;
			case "windows":
				location = "conf/log4j.properties";
				break;
